      ...
      <ModalContent>
        <ModalHeader>
          <div className="space-y-2">
            <ModalTitle>Upload folder</ModalTitle>
            <ModalDescription>
              Choose a folder and upload its files with the folder structure
              preserved.
            </ModalDescription>
          </div>
        ...
        <form onSubmit={onSubmit}>
          <ModalBody>
            ...
            <div className="space-y-2">
              <label
                htmlFor="upload-folder-files"
                className="block text-sm font-medium text-foreground"
              >
                Folder
              </label>
              <input
                id="upload-folder-files"
                ref={folderInputRef}
                type="file"
                multiple
              ...
              {uploadQueue.length > 0 ? (
                <div className="space-y-2 rounded-lg border border-border bg-muted/40 px-3 py-2">
                  ...
                  <div className="upload-queue-scroll max-h-52 space-y-2 overflow-auto pr-1">
